...
export const api: {
  ...
  logout: () => Promise<void>;
  me: (requestOptions?: ApiRequestOptions) => Promise<{ user: User }>;
  players: (requestOptions?: ApiRequestOptions) => Promise<{ players: Player[] }>;
  playerInsights: typeof client.playerInsights;
